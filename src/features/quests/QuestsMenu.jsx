...
const questsMenuStyle = "bg-variant6/50 col-span-4 row-span-full flex justify-start items-center flex-col rounded-lg border-4 border-variant6";
...
- paginate</div> */}
            ...
            <Pagination totalCount={totalCount} results={results} color="variant6" />
        </div>
    );
};
