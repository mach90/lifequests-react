...
function GuildsMaster({ guild, isPending }) {
    return (
            ...
            <Card title="Master">
                <div className={guildMasterOutputContainerStyle}>
                    {guild.images[1] && <img 
                        ...
                        src={`${serverUrl}/img/guilds/masters/${guild.images[1]}`}
                    />}
                    {guild.imageCover && <img 
                        className={guildMasterBackgroundStyle} 
                        src={`${serverUrl}/img/guilds/covers/${guild.imageCover}`} 
                    />}
                    {!isPending && <p className={guildMasterOutputStyle}>
