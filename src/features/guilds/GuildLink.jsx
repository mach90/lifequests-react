...
function GuildLink({guildId, name, emblem}) {
    return (
        <NavLink to={`/guilds/${guildId}`} className={({ isActive }) => isActive ? guildLinkActiveStyle : guildLinkStyle}>
            <img src={emblem ? `http://127.0.0.1:3000/img/guilds/${emblem}` : "http://127.0.0.1:3000/img/guilds/default-emblem.png"} alt="guild-emblem" className={guildLinkEmblemStyle} />
