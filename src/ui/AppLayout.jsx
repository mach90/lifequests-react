...
////////////////////////////////////////////////// */
const appLayoutStyle = "bg-[url(/background-app.avif)] bg-cover bg-top flex flex-col p-6 gap-6 h-screen max-w-screen";
const appLayoutMainStyle = "bg-container/75 flex-1 overflow-hidden rounded-xl";
