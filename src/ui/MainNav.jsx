...
const mainNavContainerStyle = "bg-container rounded-r-full rounded-tl-full shadow-inner shadow-black flex flex-row gap-4 justify-end items-center px-6 py-2 text-slate-200 border-4 border-slate-700";
...
const mainNavSettingsStyle = "ml-4 text-slate-500 hover:text-yellow-400";
